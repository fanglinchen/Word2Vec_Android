...
class StackoverflowDumpToDBService:
    ...
    def import_posts_from_file(self, from_date: datetime, until_date: datetime, file_path: str, table_name: str):
...
stackoverflowDumpToDBService.import_posts_from_file(
    from_date=datetime.datetime(2009, 1, 1, 0, 0, 0),
    until_date=datetime.datetime(2017, 1, 1, 0, 0, 0),
